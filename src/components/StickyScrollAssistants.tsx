...
const StickyScrollAssistants = () => {
  ...
  useEffect(() => {
    // Handle navigation with keyboard arrows
  ...
  return (
    <section ref={containerRef} id="assistants" className="w-full min-h-screen bg-gray-950 text-white overflow-hidden flex flex-col relative">
      ...
      <div className="flex-1 relative">
        ...
        <div className="absolute bottom-0 left-0 w-full p-12">
          ...
          >
            ...
            <div className="mt-12">
              <button 
                className={`px-8 py-4 rounded-lg bg-gradient-to-r ${agent.color} text-white font-bold text-lg shadow-lg hover:shadow-xl transition-all`}
              >
...
export default StickyScrollAssistants; 