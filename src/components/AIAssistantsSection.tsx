  ...
  return (
    <section id="assistants" className="w-full min-h-screen bg-gray-950 text-white overflow-hidden flex flex-col relative">
      ...
      <div className="flex-1 relative">
        ...
        <div className={`absolute inset-0 transition-all duration-700 opacity-70 ${agent.gradient}`}></div>
        ...
        >
          <div className="w-full h-full relative overflow-hidden">
            {/* Background Agent Image - 80% opacity */}
            <div 
              className="w-full h-full absolute top-0 left-0 bg-cover bg-top opacity-80"
              style={{
            ...
            ></div>
            <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-t from-gray-950 via-gray-950/60 to-gray-950/40"></div>
          </div>
        </div>
        ...
        >
          <div className="mb-2">
            <span className="block text-xs font-semibold tracking-widest text-white/70 uppercase mb-2">MEET THE TEAM</span>
            <h1 
